...
$sql= "SELECT * FROM audio_video_type LIMIT $start_from, $record_per_page "; 
...
<div class="item1">
	<div class="search_menu">
		<button onclick="window.location.href='audio_type_add.php';">Lisa uus</button>
		<button type="submit" form="form2" name="export"  >Ekspordi CSV</button>
		<button onclick="window.location.href='audio_video_type.php';">Tühista filtreering</button>
<br><br>
<!--andmete eksport--> 
 <form method="post" action="audio_type_export.php" id="form2" name="export">  </form>  
...
/*viimane otsing jääb otsing aknasse*/
 ...
 <!--filtreeringu tühistamiseks laeb lehe uuesti-->		
		<button onclick="window.location.href='audio_video_type_data.php';">Tühista filtreering</button>
</div> </div>
<div class="item2">
 <!--raamatute menüü-->
<?php
...
if($column1 == 'include'){
$sql= "SELECT * FROM audio_video_type where $column like '%$search%' " ;}
	
elseif($column1 == 'starts'){
$sql= "SELECT * FROM audio_video_type_type where $column like ' " . $search . "%' " ;} // esitähe järgi 
	
elseif($column1 == 'ends'){
$sql= "SELECT * FROM audio_video_type where $column like '%" . $search . "' " ;} //viimase tähe järgi

elseif($column1 == 'exactly'){
$sql= "SELECT * FROM audio_video_type where $column like ' " . $search . " ' " ;} //täpselt  ei toimi 
}
