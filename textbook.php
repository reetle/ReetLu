...
kogus, riiul, marksona FROM library_fund where meedia_liik like 'op' order by pealkiri LIMIT $start_from, $record_per_page" ;
...
if (isset($_POST['column'])){
	...
	$sql= "SELECT id, klass, pealkiri, autor, ilmumisaasta, liik, keel, valjaandja, 
	kogus, riiul, marksona FROM library_fund where meedia_liik like 'op' AND  $column like '%$search%'" ;}
$result = mysqli_query($conn, $sql) or die("error:".mysqli_error($conn));
}
