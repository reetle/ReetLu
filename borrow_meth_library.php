...
<div class="row" id="borrow">
  ...
  <br>
  <p> Kas sa soovid antud metoodilist kirjandust laenutada: </p>
 <?php
include_once("config.php");
$id = $_GET['id'];
$result = mysqli_query($conn, "SELECT * FROM met_library WHERE id=$id") ;
...
$result = mysqli_query($conn, "INSERT INTO met_library (lugeja, meedia_id, meedia_liik,
