...
$sql= "SELECT id, pealkiri,klass,  autor, ilmumisaasta, liik, keel, valjaandja, kogus,
 riiul, marksona FROM library_fund where meedia_liik like 'op' LIMIT $start_from, $record_per_page" ;
...
<div class= "menu">
  ...
  <div class="item3"> 
	...
	$page_query = "SELECT id, klass, pealkiri, autor, ilmumisaasta, liik, keel, valjaandja, kogus, riiul, marksona FROM library_fund where meedia_liik like 'op'";
    ...
    if($page > 1)
    {
     echo "<a href='workbook.php?page=1'>Tagasi</a>";
    ...
    {
     echo "<a href='workbook.php?page=".($page + 1)."'>>></a>";
     echo "<a href='workbook.php?page=".$total_pages."'>Edasi</a>";
    }
  ?>  
</div>	
<div class="item4">
