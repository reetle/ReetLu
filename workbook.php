...
$sql= "SELECT id, pealkiri,klass,  autor, ilmumisaasta, liik, keel, valjaandja, kogus,
 riiul, marksõna FROM library_fund where meedia_liik like 'op' LIMIT $start_from, $record_per_page" ;
...
<div class= "menu">
  ...
  <div class="item3"> 
	...
	$page_query = "SELECT id, klass, pealkiri, autor, ilmumisaasta, liik, keel, valjaandja, kogus, riiul, marksõna FROM library_fund where meedia_liik like 'op'";
