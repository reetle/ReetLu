...
$sql= "SELECT id, pealkiri,andmekandja, autor, ilmumisaasta, liik, keel,
 valjaandja, kogus, riiul, marksona FROM library_fund where meedia_liik like 'av' LIMIT $start_from, $record_per_page" ;
...
<div class= "menu">
 ...
 valjaandja, kogus, riiul, marksona FROM library_fund where meedia_liik like 'av'";
