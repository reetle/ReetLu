...
<br><br>
<!--andmete eksport--> 
 <form method="post" action="author_export.php" id="form2" name="export">  </form>  
...
?>
 ...
 <!-- filtreerib pealkirja järgi kasvavalt või kahanevalt, &#8693; lisab nooled -->	
		...
		<th onclick="sortTable(2)">Eesnimi &#8693;</th> 
		<th onclick="sortTable(3)">Eluaastad &#8693;</th> 
		<th onclick="sortTable(4)">Rahvus &#8693;</th>
...
<?php
    ...
    if($page > 1)
    {
     echo "<a href='author_data.php?page=1'> Algusesse </a>";
     echo "<a href='author_data.php?page=".($page - 1)."'> << </a>";
    }
    for($i=$start_loop; $i<=$end_loop; $i++)
    {     
     echo "<a href='author_data.php?page=".$i."'>" .$i. "</a>";
    }
    if($page <= $end_loop)
    {
     echo "<a href='author_data.php?page=".($page + 1)."'> >> </a>";
     echo "<a href='author_data.php?page=".$total_pages."'> Lõppu </a>";
    }
  ?>  
 </div>
</div>	
