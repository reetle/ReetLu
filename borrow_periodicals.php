...
$result = mysqli_query($conn, "INSERT INTO borrow_book (lugeja, meedia_id, meedia_liik, pealkiri , kogus, algus_kp)
SELECT '$lugeja', periodicals.id, 'PE', periodicals.pealkiri, '$kogus', '$algus_kp'
...
?> 
<div class="back_but">
<button onclick="window.location.href='periodicals_data.php';" >Tagasi</button>
</div> 
</div>
</body>
</html>
