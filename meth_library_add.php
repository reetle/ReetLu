...
<title>Lisa Metoodiline kirjanuds</title>
<meta charset="utf-8">
...
<div class="add_data">
	...
	$result = mysqli_query($conn, "INSERT INTO met_library (pealkiri, klass, tuup,  autor, aasta, liik, keel,valjaandja, kogus, riiul, marksona, markused) 
	VALUES('$pealkiri','$klass', '$tuup','$autor','$aasta', '$liik','$keel','$valjaandja','$kogus', '$riiul','$marksona','$markused')");
		echo " <p>Lisatud </p>";
	}
	?>
<button onclick="window.location.href='meth_library_data.php';" >Tagasi</button>
</div>
</body>
</html>