...
//Raamat
	if ($select == 'book') {        
		header("Location: write_off_book_select.php"); 
}
//õpik
	elseif ($select == 'textbook' ) {	
	header("Location: write_off_textbook_select.php");   
}
//perioodika
	elseif ($select == 'periodicals' ) {	
	header("Location: write_off_periodicals_select.php");		
}
//audio-video
	elseif($select == 'audio-video' ) {	
	header("Location: write_off_audio_select.php");
}	

//töövihik
	elseif ($select == 'workbook' ) {
		header("Location: write_off_workbook_select.php");
}		
//metoodiline kirjandus
	elseif ($select == 'meth-library' ) {
		header("Location: write_off_meth_select.php");
