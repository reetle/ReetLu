...
<body> 
	...
	$result = mysqli_query($conn, "INSERT INTO workbook(pealkiri, klass, autor, aasta, liik, keel,valjaandja, kogus, riiul, marksona, markused) 
	VALUES('$pealkiri','$klass','$autor','$aasta', '$liik','$keel','$valjaandja','$kogus', '$riiul','$marksona','$markused')");
		echo "Lisatud </a>";
	}
	?>
<div id="back_button">
<a href="workbook_data.php">Tagasi</a>
</body>
</html>