...
$sql= "SELECT id, klass, pealkiri,  tuup, autor, aasta, liik, keel, valjaandja, 
kogus, riiul, marksona, markused FROM met_library order by pealkiri LIMIT $start_from, $record_per_page" ;
...
<title>Metoodiline krijandus</title>
<meta charset="UTF-8" />
...
<input type="button" value="Tühista" onclick="location.href='meth_library.php'"  />
...
<div class= "menu">
  ...
  <table  id="table1">
    <tr>
		...
		<th onclick="sortTable(1)">MK klass</th>  
		<th onclick="sortTable(2)">MK tüüp</th>  
...
if (isset($_POST['column'])){
	...
	$sql= "SELECT id, klass, pealkiri,  tuup, autor, aasta, liik, keel, valjaandja, 
kogus, riiul, marksona, markused FROM met_library where  $column like '%$search%'" ;}
$result = mysqli_query($conn, $sql) or die("error:".mysqli_error($conn));
}
...
<?php
	...
	$page_query = "SELECT id, klass, pealkiri,  tuup, autor, aasta, liik, keel, valjaandja, 
kogus, riiul, marksona, markused FROM met_library";
