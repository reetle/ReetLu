...
$sql= "SELECT * FROM languages LIMIT $start_from, $record_per_page "; 
...
?>
 ...
 <div class="col-lg-10" style="margin-bottom:33rem; "id="filter">
	<div class="search_menu">
		<button onclick="window.location.href='languages_add.php';">Lisa uus</button>
		<button type="submit" form="form2" name="export"  >Ekspordi CSV</button>
		<button onclick="window.location.href='languages_data.php';">Tühista filtreering</button>
<br><br>
<!--andmete eksport--> 
 <form method="post" action="languages_export.php" id="form2" name="export">  </form>  
...
if($column1 == 'include'){
$sql= "SELECT * FROM languages where $column like '%$search%' " ;}
	
elseif($column1 == 'starts'){
$sql= "SELECT * FROM languages where $column like ' " . $search . "%' " ;} // esitähe järgi 
	
elseif($column1 == 'ends'){
$sql= "SELECT * FROM languages where $column like '%" . $search . "' " ;} //viimase tähe järgi

elseif($column1 == 'exactly'){
$sql= "SELECT * FROM languages where $column like ' " . $search . " ' " ;} //täpselt  ei toimi 
}
...
<?php
    ...
    if($page > 1)
    {
     echo "<a href='languages_data.php?page=".($page - 1)."'> << </a>";
    }
    for($i=$start_loop; $i<=$end_loop; $i++)
    {     
     echo "<a href='languages_data.php?page=".$i."'>" .$i. "</a>";
    }
    if($page <= $end_loop)
    {
     echo "<a href='languages_data.php?page=".($page + 1)."'> >> </a>";
     echo "<a href='languages_data.php?page=".$total_pages."'> Lõppu </a>";
    }
  ?>  
  -->
 </div>
